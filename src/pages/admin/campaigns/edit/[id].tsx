...
import { Container, Row, Col, Card, CardBody, CardHeader, Form, FormGroup, Label, Input, Button, FormText, Spinner, Nav, NavItem, NavLink, TabContent, TabPane } from "reactstrap";
  ...
  const fetchCampaign = async () => {
    try {
      ...
      const translations = campaign.translations || [
        { language: 'tr', title: campaign.title || '', slug: campaign.slug || '', description: campaign.description || '' },
        { language: 'en', title: '', slug: '', description: '' },
        { language: 'ar', title: '', slug: '', description: '' }
      ];
      ...
      const ensureAllLanguages = (trans: any[]) => {
        ...
        return languages.map(lang => {
          ...
          return existing || { language: lang, title: '', slug: '', description: '' };
        });
      };

      setFormData({
        translations: ensureAllLanguages(translations.length > 0 ? translations : [
          { language: 'tr', title: campaign.title || '', slug: campaign.slug || '', description: campaign.description || '' },
          { language: 'en', title: '', slug: '', description: '' },
          { language: 'ar', title: '', slug: '', description: '' }
        ]),
