...
const TimelineEdit = () => {
  ...
  const fetchTimeline = async () => {
    try {
      setLoadingData(true);
      const timeline = await timelineService.getTimelineById(Number(id));
      ...
      console.error('Tarihçe kaydı yüklenirken hata:', error);
      toast.error('Tarihçe kaydı yüklenirken hata oluştu');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await timelineService.updateTimeline(Number(id), {
      ...
      toast.success('Tarihçe kaydı başarıyla güncellendi');
      router.push('/admin/timeline');
    } catch (error: any) {
      console.error('Tarihçe kaydı güncellenirken hata:', error);
      toast.error(error.response?.data?.message || 'Tarihçe kaydı güncellenirken hata oluştu');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="page-body">
        <Container fluid={true}>
          <div className="text-center py-5">
            ...
            <p className="mt-2">Tarihçe kaydı yükleniyor...</p>
          </div>
        </Container>
      </div>
    );
  ...
  return (
    <div className="page-body">
      <Breadcrumbs title="Tarihçe Kaydı Düzenle" mainTitle="Tarihçe Düzenle" parent={Dashboard} />
      <Container fluid={true}>
        <Row>
            ...
            <Card>
              <CardHeader>
                <div className="d-flex justify-content-between align-items-center">
                  <h5 className="mb-0">Tarihçe Kaydı Düzenle</h5>
