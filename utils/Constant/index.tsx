...
export const Footertext: string = "Copyright 2023 © YYD theme by pixelstrap";
...
export const YYDLogin: string = "YYD Login";
export const YYDLoginText: string =
...
export const YYDProfile: string = "YYD Profiles For New Employees:";
...
export const YYDTheme: string = "YYD Theme";
...
export const YYDText = "YYD Telecom & Technologies , NY";
export const Months = [
  "January",
  "February",
  "March",
...
export const YYDUnitedStates = "YYD - United States";
